...
class Conversation(Base):
    ...
    reply_to: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("conversations.message_id"))
    reply: Mapped["Conversation"] = relationship("conversations", remote_side=[message_id], backref="replies")